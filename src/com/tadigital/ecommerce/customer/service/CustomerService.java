...
public class CustomerService {
	...
	public boolean registerCustomer(Customer c) {
		...
		if(status) {
			sendEmail(c.getFirstName()+" "+c.getLastName(),c.getEmail());
		}
		
		return status;
	}
	public boolean loginCustomer(Customer c) {
		boolean s=cd.selectCustomerByEmailAndPassword(c);
		return s;
	}
	public String sendEmail(String name,String mail)
	{
		...
		Session session = Session.getDefaultInstance(properties,new javax.mail.Authenticator() {
																	protected PasswordAuthentication getPasswordAuthentication() {
																		return new PasswordAuthentication("sowmyal1998@gmail.com","xxxx");
																	}
																});
		try {
			//COMPOSE MESSAGE
			MimeMessage mimeMessage = new MimeMessage(session);
			mimeMessage.setFrom(new InternetAddress("sowmyal1998@gmail.com"));
			...
			String msg ="<body bgcolor='AliceBlue'>Dear <i><font color='DarkBlue'>" + name + "</font></i>,<br/><br/>" +
			"<img src='cid:img1'><br/><h2><font color='#C70039'>Welcome to TA Digital Family!</font></h2>" +
			"<br/><font color='brown'>We are excited to have you on-board.</font>" +
			"<br/><br/><br/><font color='violet'>Stay tuned and we have got some great things in store for you.</font>" +
			"<br/><br/><br/><font color='#FFC300'>Happy Shopping!<br/>TA Digital<br/><br/></font><img src='cid:img2'></body>";
			...
			DataSource fds = new FileDataSource("E:/Trainee Engineers March 2019/workspace/TrainingProject_Sowmya/WebContent/images/logo.png");
			mbp1.setDataHandler(new DataHandler(fds));
			mbp1.setHeader("Content-ID", "<img1>");
			mp.addBodyPart(mbp1);

			mbp1 = new MimeBodyPart();
			fds = new FileDataSource("E:/Trainee Engineers March 2019/workspace/TrainingProject_Sowmya/WebContent/images/welcome.jpg");
			mbp1.setDataHandler(new DataHandler(fds));
			mbp1.setHeader("Content-ID", "<img2>");
			mp.addBodyPart(mbp1);

			mimeMessage.setContent(mp);mimeMessage.setText(msg);
